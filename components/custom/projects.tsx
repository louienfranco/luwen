...
const projects: Project[] = [
  {
    ...
    description:
      "Product Costing helps you quickly determine the true cost of a product by combining materials, labor, and overhead into one clear, accurate breakdown for smarter decision-making.",
    tags: ["Next.js", "Tailwind", "TypeScript"],
    url: "https://productcosting.vercel.app",
  },
  {
    id: "p2",
    title: "Image Compressor",
    description:
      "ImgLite lets you effortlessly optimize, compress, and enhance images in seconds, giving you fast, high-quality results with minimal effort.",
    tags: ["Next.js", "Tailwind", "TypeScript"],
    url: "https://imglite.vercel.app",
  },
  {
    id: "p3",
    title: "Asinta Company Profile",
    description:
      "Asinta Company Profile showcases the vision, expertise, and portfolio of a leading architecture firm, highlighting innovative designs, sustainable solutions, and client-focused projects.",
    tags: ["Next.js", "Tailwind", "TypeScript"],
          ...
          <div className="md:sticky md:top-24 lg:top-28 xl:top-32">
            <div className="md:h-[calc(100vh-20rem)] flex items-center">
              <div className="w-full">
                {/* Header removed here to avoid duplication; top header is used */}
  ...
  forwardRef<HTMLDivElement, { index: number; project: Project }>(
    function ObservedPanel({ index, project }, ref) {
      return (
        ...
        >
          <div className="w-full">
            <ProjectMediaProject index={index} project={project} />
...
/**
 * Visual Project card for project media (image/video).
 */
const ProjectMediaProject = memo(function ProjectMediaProject({
  index,
  project,
}: {
  index: number;
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {url ? (
          <a
            ...
            className="rounded-full border bg-background/70 px-4 py-2 text-sm font-medium backdrop-blur flex items-center gap-2 hover:opacity-95 transition-opacity cursor-pointer"
          >
